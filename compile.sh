...
x86_64-elf-g++ -c api/api.cpp -o bin/os/api2.o -ffreestanding -Wall -Wextra -fno-exceptions -mcmodel=large -fno-rtti -g -DARCH_64 -DARCH_X86_64 -DARCH_X86_COMMON -std=c++11 -Wno-frame-address -Wno-unused-function -O3
