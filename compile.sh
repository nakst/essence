...
echo "-> Building shell..."
x86_64-elf-g++ -c shell/main.cpp -o bin/os/shell.o -ffreestanding -Wall -Wextra -fno-exceptions -mcmodel=large -fno-rtti -g -DOS_H_HELPER_FUNCTIONS -DARCH_64 -DARCH_X86_64 -DARCH_X86_COMMON -std=c++11 -Wno-frame-address  
